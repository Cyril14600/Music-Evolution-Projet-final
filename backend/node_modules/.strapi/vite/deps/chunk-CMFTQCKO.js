...
import {
  LimitsModal
} from "./chunk-CROOGKOG.js";
import {
  AssigneeColumn,
  StageColumn,
  getDisplayName
} from "./chunk-3JCRW3YY.js";
import {
  getStageColorByHex
} from "./chunk-TQSTBX33.js";
import {
...
} from "./chunk-R6K42BIE.js";
import {
  useTypedSelector
} from "./chunk-XXCOWGGK.js";
import {
  ReleaseActionMenu,
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-U56AOZPK.js";
import {
  useConfig,
  useTracking
} from "./chunk-VSW2DIZJ.js";
import {
  AssetSource,
  AssetType,
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-2CXYPABL.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-6PKHXKGB.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-K744VQ2X.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-UI3ADKYD.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-RZTK72TG.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-ONDUKFN6.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-YTZY6IKF.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-X6V2TBNP.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-IQFDS26U.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-APEUCUSZ.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-U7NCUZV4.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-NOKLQKNV.js");
          return {
...
//# sourceMappingURL=chunk-CMFTQCKO.js.map
